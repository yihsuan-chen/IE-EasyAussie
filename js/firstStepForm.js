      ...
      function showTab(n) {
          ...
          if (n == (x.length - 1)) {
              ...
              //$('#nextBtn').css("color","rgb(153,189,219)");
          }
          fixStepIndicator(n)
      }
      ...
      function validateForm() {
          ...
          for (i = 0; i < y.length; i++) {
              ...
              if (!(na.test(y[i].value)) && document.getElementById('othersInput').style.display == "block") {
                  y[i].className += " invalid";
                  valid[0] = false;
              } else if ((na.test(y[i].value)) && matchingResult == 'Nothing found please enter the right suburb name') {
                  y[i].className += " invalid";
                  document.getElementById('hint').innerHTML = matchingResult;
      ...
      $(document).ready(function() {
          $(".universityList").change(function() {
              ...
              campus[0] = new Array("Clayton", "Caulfield", "Berwick", "Parkville");
              campus[1] = new Array("Parkville", "Burnley", "Southbank", "Werribee");
              campus[2] = new Array("CBD", "Brunswick", "Bundoora");
              campus[3] = new Array("Hawthorn", "Croydon", "Wantirna");
              campus[4] = new Array("Kew");
              campus[5] = new Array("Footscray", "CBD", "Werribee", "Sunshine");
